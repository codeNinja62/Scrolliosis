...
fun WelcomeScreen(
    ...
    Column(
        ...
        Icon(
            ...
            contentDescription = "BrainGate Logo",
            tint = PrimaryAccent,
        ...
        Text(
            text = "Hard-block your distractions. Reclaim your focus. BrainGate physically stops you from opening the apps that steal your time.",
            textAlign = TextAlign.Center,
